# This code builds the model M3: M0 with an adjustable traveler weight.
...
build_spatPomp_M3 <- function(
  ...
  writexl::write_xlsx(df_ds_cap, "results/figs/model_simulation/M3/diagnostic_and_sequencing_capacities_daily.xlsx")
