get_unit_state_names <- function(num_of_strains, U){
  unit_state_names <- c(
    ...
    paste0(paste0("E_", seq_len(num_of_strains), "_i_direct_in_origin_"), rep(seq_len(U)-1, each=4), "_"), # imported exposed originated from u
    paste0(paste0("I_", seq_len(num_of_strains), "_i_direct_in_origin_"), rep(seq_len(U)-1, each=4), "_"), # imported infected originated from u
    paste0(paste0("E_", seq_len(num_of_strains), "_i_transit_first_origin_"), rep(seq_len(U)-1, each=4), "_"), # imported exposed transit originated from u
    paste0(paste0("I_", seq_len(num_of_strains), "_i_transit_first_origin_"), rep(seq_len(U)-1, each=4), "_"), # imported infected transit originated from u
    ...
    paste0(paste0(paste0("C_", seq_len(num_of_strains), "_i_infected_origin_"), rep(seq_len(U)-1, each=4)), "_new"), # infected cases originated from u
    paste0(paste0(paste0("C_", seq_len(num_of_strains), "_i_detected_origin_"), rep(seq_len(U)-1, each=4)), "_new"), # detected imported cases originated from u
    paste0(paste0(paste0("C_", seq_len(num_of_strains), "_i_sequenced_origin_"), rep(seq_len(U)-1, each=4)), "_new"), # sequenced imported cases originated from u, these will be fitted, N=116
