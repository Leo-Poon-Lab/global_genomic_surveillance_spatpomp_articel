...
for (u = 0 ; u < U ; u++) {
  ...
  E_1_i[u] = E_1_i_direct_in[u] + E_1_i_transit_first[u];
  E_2_i[u] = E_2_i_direct_in[u] + E_2_i_transit_first[u];
  E_3_i[u] = E_3_i_direct_in[u] + E_3_i_transit_first[u];
  E_4_i[u] = E_4_i_direct_in[u] + E_4_i_transit_first[u];
  I_1_i[u] = I_1_i_direct_in[u] + I_1_i_transit_first[u];
  I_2_i[u] = I_2_i_direct_in[u] + I_2_i_transit_first[u];
  I_3_i[u] = I_3_i_direct_in[u] + I_3_i_transit_first[u];
  I_4_i[u] = I_4_i_direct_in[u] + I_4_i_transit_first[u];
  ...
  R[u] += nearbyint(
    ...
    dN[I1i0_R] + dN[I2i0_R] + dN[I3i0_R] + dN[I4i0_R] +
    dN[I1i1_R] + dN[I2i1_R] + dN[I3i1_R] + dN[I4i1_R]
    );
  D[u] += nearbyint(
    dN[I1c_D] + dN[I2c_D] + dN[I3c_D] + dN[I4c_D] +
    dN[I1i0_D] + dN[I2i0_D] + dN[I3i0_D] + dN[I4i0_D] +
    dN[I1i1_D] + dN[I2i1_D] + dN[I3i1_D] + dN[I4i1_D]
    );
  ...
  C_1_i_infected_new[u] += dN[I1i0_R] + dN[I1i0_D] + dN[I1i1_R] + dN[I1i1_D];
  C_2_i_infected_new[u] += dN[I2i0_R] + dN[I2i0_D] + dN[I2i1_R] + dN[I2i1_D];
  C_3_i_infected_new[u] += dN[I3i0_R] + dN[I3i0_D] + dN[I3i1_R] + dN[I3i1_D];
  C_4_i_infected_new[u] += dN[I4i0_R] + dN[I4i0_D] + dN[I4i1_R] + dN[I4i1_D];

  C_1_all_infected_new[u] = C_1_c_infected_new[u] + C_1_i_infected_new[u];
  C_2_all_infected_new[u] = C_2_c_infected_new[u] + C_2_i_infected_new[u];
  C_3_all_infected_new[u] = C_3_c_infected_new[u] + C_3_i_infected_new[u];
  C_4_all_infected_new[u] = C_4_c_infected_new[u] + C_4_i_infected_new[u];
